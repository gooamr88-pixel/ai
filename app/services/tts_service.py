...
VIDEO_SYSTEM_PROMPT = (
    ...
    "قواعد الدقة ومنع الهلوسة (CRITICAL — 100% Accuracy & Anti-Hallucination):\n"
    "- يجب عليك الالتزام التام والكامل بالحقائق والمعلومات المذكورة في النص المرفق فقط.\n"
    "- ممنوع تماماً اختراع أو افتراض أي أرقام، إحصائيات، تواريخ، أسماء، أو مفاهيم غير موجودة صراحةً بالنص المصدر.\n"
    "- لا تستخدم أي معرفة خارجية خارج حدود النص المرفق. كل الشروحات والمفاهيم يجب أن تكون مستندة بنسبة 100% على النص المرفق.\n"
    "- إذا احتجت للتوسع لشرح فكرة أو لملء عدد الشرائح المطلوبة، فقم بذلك عن طريق تبسيط المفاهيم الموجودة بالفعل في النص، أو إعادة صياغتها، أو توفير أمثلة افتراضية توضيحية مبنية مباشرة على حقائق النص، دون إدخال أي مفاهيم خارجية جديدة.\n\n"

...
async def generate_question_bank(text: str, num_questions: int = 50, difficulty: str = "medium") -> QuestionBank:
    ...
    # PAD the arrays if Gemini generated too few questions to avoid Pydantic min_items=50 failure
    while len(final_mcqs) < 30:
        final_mcqs.append({
            "question": "Placeholder MCQ Question (Generated by fallback padding logic)",
            "options": [{"text": "A", "is_correct": True}, {"text": "B", "is_correct": False}, {"text": "C", "is_correct": False}, {"text": "D", "is_correct": False}],
            "explanation": "Placeholder",
            "difficulty": difficulty
        })
    while len(final_tfs) < 20:
        final_tfs.append({
            "question": "Placeholder T/F Question (Generated by fallback padding logic)",
